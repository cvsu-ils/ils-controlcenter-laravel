    ...
    <div class="h-screen flex lg:flex flex-row w-full h-screen">
            ...
            <div class="flex items-center justify-center h-screen">
                <div class="items-center pb-28 lg:pb-2 flex flex-col items-center sm:flex flex-col items-center">
                    ...
                    <div class=" align-text-top text-center lg:text-center text-white mb-2">
                        <p class="font-bold text-lg md:text-2xl lg:text-2xl">CAVITE STATE UNIVERSITY <br> INTEGRATED LIBRARY SYSTEM</p>
                    ...
                    <div>
                        <h1 class="text-2xl font-medium text-center mb-2 text-gray-700">Accessing the CvSU Integrated Library System Control Center
                        <br>
                    ...
                    <div class="absolute bottom-0 text-center ml-4 sm:ml-10 md:ml-20 lg:hidden">
                        <p class="text-base font-medium text-white">© Copyright 2022 &sdot; Cavite State University Integrated Library System &sdot; Control Center v5.0</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="hidden lg:block w-1/2 flex flex-col">
            <div class="flex h-full justify-center items-center space-y-8 bg-[#F6FFF1]">
                <div class="text-center rounded-3xl px-16">
                    <div class="py-8 px-8 pt-2 bg-white rounded-2xl shadow-xl z-20 border border-gray-2 00">
                        <div>
                            <h1 class="text-2xl font-medium text-center mb-2 mt-3">Accessing the CvSU Integrated Library System Control Center
                            <br><span class="text-base font-normal"><i>(For librarian and library staffs only)</i></span>
                            </h1>
                            <hr class="mb-2">
                            <p class="text-center text-lg mb-6 p-2 font-semibold text-gray-700 tracking-wide">
                                The CvSU Control Center intelligently adapts based on your login information. It dynamically presents the modules you need for essential library tasks
            ...
            <div class="absolute bottom-0 text-center p-4 ml-10 lg:absolute bottom-0 text-center p-4 ml-2">
                <p class="text-base font-medium text-gray-700">© Copyright 2022 &sdot; Cavite State University Integrated Library System &sdot; Control Center v5.0</p>
            </div>
        </div>
