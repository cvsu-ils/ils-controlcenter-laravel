                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @forelse($data as $row) <!-- Using $theses fetched from the controller -->
                                                ...
                                                <td><a  href="{{ route('admin.ltx.edit', $row->id) }}" type="button" class="btn btn-primary rounded-0"><i class="fas fa-edit"></i></a></td>
                                                </tr>
                                            @empty
                                                <tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <div class="dataTables_paginate paging_numbers">
                                        {{ $data->links() }} <!-- Laravel's built-in pagination links -->
                                    </div>
                                </div>
                            </div>
                        </div>
